...
entity ProposalOwner {
    key id                   : Integer;
        ...
        modifiedBy           : String(50);
        modifiedAt           : Timestamp;
        proposalOwnerContact : Association to many ProposalOwnerContact
                                   on proposalOwnerContact.proposalOwner = $self;
...
entity ProposalClient {
    key id                    : Integer;
        ...
        modifiedBy            : String(50);
        modifiedAt            : Timestamp;
        proposalClientContact : Association to many ProposalClientContact
                                    on proposalClientContact.proposalClient = $self;
        proposalDetails       : Association to ProposalDetails;
}
...
entity ProposalDetails {
    key id                 : String;
        ...
        modifiedBy         : String(50);
        modifiedAt         : Timestamp;
        mainSection        : Association to many MainSection
                                 on mainSection.proposalDetails = $self;
        proposalOwner      : Association to ProposalOwner;
        proposalClient     : Association to ProposalClient;
...
entity MainSection {
    key id               : String;
        ...
        modifiedAt       : Timestamp;
        proposalDetails  : Association to ProposalDetails;
        tablearea        : Association to many MainTableFields
                               on tablearea.mainSection = $self;
        subsection       : Association to many SubSection
                               on subsection.parentSection = $self;
